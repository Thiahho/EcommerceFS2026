  ...
  return (
    <div className="space-y-10">
      <header className="space-y-3">
        ...
        <p className="text-sm text-slate-600">Filtrá por marca, categoría, rango de precio y promos activas.</p>
      </header>

      <section className="grid gap-6 md:grid-cols-[260px_1fr]">
        <aside className="card space-y-6">
          <div>
            <label className="text-xs font-semibold uppercase text-slate-500">Marca</label>
            <select
